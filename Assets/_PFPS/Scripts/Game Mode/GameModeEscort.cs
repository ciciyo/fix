...
{
    public class GameModeEscort : MonoBehaviour
    {
        ...
        public static bool IsReachDestination = false;
        ...
        private void Update()
        {
            if (!_isGameStopped)
            {
                ...
                var killDescription = $"Escort the item";
                LogGameMode.OnUpdate(timeMinutesAndSeconds, killDescription);
            }
